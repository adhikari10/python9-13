...
print("{:<12} {:<15} {:<15} {:<20}".format("Registration", "Max Speed (km/h)", "Current Speed (km/h)",
                                           "Travelled Distance (km)"))
print("-" * 62)
for car in cars:
    print("{:<12} {:<15} {:<15} {:<20}".format(car.registration_number, car.maximum_speed, car.current_speed,
